...
<!-- TAB WISHLIST -->
        <div class="tab-pane fade" id="wishlist" role="tabpanel">
            <div class="scroll-area">
                <?php if(!empty($wishlist_produk)): ?>
                    <?php foreach($wishlist_produk as $row): ?>
                        <div class="wishlist-item">
                            ...
                            <div class="wishlist-buttons">
                                ...
                                <a href="profil.php?hapus=<?= $row['id_produk'] ?>" class="btn btn-hapus" onclick="return confirm('Hapus dari wishlist?')">Hapus</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
