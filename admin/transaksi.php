                ...
                <td>
                  ...
                  <?php } elseif ($status == 'kirim') { ?>
                    ...
                    <a href="#" class="btn btn-danger btn-sm"
                      onclick="batalTransaksi(<?= $row['id_transaksi']; ?>)">
                      Batal
                    </a>

                    <script>
                      function batalTransaksi(id) {
                        let alasan = prompt("Masukkan alasan pembatalan transaksi:");

                        if (alasan === null || alasan.trim() === "") {
                          alert("Pembatalan dibatalkan karena alasan tidak diberikan.");
                          return;
                        }

                        // Arahkan ke file pembatalan + kirim alasan
                        window.location = "transaksi_batal.php?id=" + id + "&alasan=" + encodeURIComponent(alasan);
                      }
                    </script>
