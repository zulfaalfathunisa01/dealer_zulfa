...
// ===== Ambil data customer otomatis =====
$id_pengguna = $_SESSION['id_pengguna'];
$pengguna = $koneksi->query("SELECT * FROM pengguna WHERE id_pengguna = $id_pengguna")->fetch_assoc();
...
// ===== Ambil produk via GET (opsional satuan) =====
if (isset($_GET['id'])) {
    $id_produk = $_GET['id'];
...
// ===== Ambil produk terpilih dari keranjang =====
            ...
            <div class="form-section">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" id="no_hp" name="no_hp" class="form-control"
                           value="<?= htmlspecialchars($pengguna['no_hp']) ?>" required>
                </div>

                <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat Lengkap</label>
                    <textarea id="alamat" name="alamat" class="form-control" rows="3" required><?= htmlspecialchars($pengguna['alamat']) ?></textarea>
                </div>
